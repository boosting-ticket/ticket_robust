...
cmd2 = "python enhance.py vgg16 pure --gpu " + str(GPU) + " --max_pruning_ratio " + str(RATIO) + " --enhance_learning_rate 0.1 --model_name init_enhance_m"+str(TRAIN_LR)+"_warmup0.1 --init --mask_name " + MASK_NAME
# enhance with mask and random initial weights
cmd3 = "python enhance.py vgg16 pure --gpu " + str(GPU) + " --max_pruning_ratio " + str(RATIO) + " --enhance_learning_rate 0.1 --model_name seed9_enhance_m"+str(TRAIN_LR)+"_warmup0.1 --mask_name " + MASK_NAME
