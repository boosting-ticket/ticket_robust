...
cmd2 = "python enhance.py "+MODEL_TYPE+" pure --gpu " + str(GPU) + " --max_pruning_ratio " + str(RATIO) + " --enhance_learning_rate 0.01 --warmup --model_name init_enhance_m"+str(TRAIN_LR)+"_0.01 --init --mask_name " + MASK_NAME
# enhance with mask and random initial weights
cmd3 = "python enhance.py "+MODEL_TYPE+" pure --gpu " + str(GPU) + " --max_pruning_ratio " + str(RATIO) + " --enhance_learning_rate 0.01 --warmup --model_name seed9_enhance_m"+str(TRAIN_LR)+"_0.01 --mask_name " + MASK_NAME
