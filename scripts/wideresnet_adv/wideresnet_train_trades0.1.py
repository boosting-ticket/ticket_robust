...
cmd0 = "python train.py "+MODEL_TYPE+" pure --gpu " + str(GPU) + " --train_method trades --norm --max_pruning_ratio " + str(RATIO) + " --warmup --learning_rate " + str(TRAIN_LR) + " --model_name " + MODEL_NAME
